...
export type Portfolio_UserType = {
  /** Required. 150 characters or fewer. Letters, digits and @/./+/-/_ only. */
  username: Scalars['String'];
  email: Scalars['String'];
  profiles: Array<Portfolio_ProfileType>;
  languages?: Maybe<Array<Maybe<Portfolio_SkillType>>>;
  frameworks?: Maybe<Array<Maybe<Portfolio_SkillType>>>;
  databases?: Maybe<Array<Maybe<Portfolio_SkillType>>>;
  operatingSystems?: Maybe<Array<Maybe<Portfolio_SkillType>>>;
  services?: Maybe<Array<Maybe<Portfolio_SkillType>>>;
  tools?: Maybe<Array<Maybe<Portfolio_SkillType>>>;
};

export type Portfolio_ProfileType = {
...
export type Portfolio_SkillType = {
  name: Scalars['String'];
  experiencePeriod: Scalars['String'];
  skilled: Scalars['Boolean'];
  like: Scalars['Boolean'];
};

export type Portfolio_BlogPostConnection = {
  /** Pagination data for this connection. */
  pageInfo: Portfolio_PageInfo;
  /** Contains the nodes in this connection. */
  edges: Array<Maybe<Portfolio_BlogPostEdge>>;
};

/** The Relay compliant `PageInfo` type, containing data necessary to paginate this connection. */
export type Portfolio_PageInfo = {
...
export type Portfolio_BlogPostEdge = {
  /** The item at the end of the edge */
  node?: Maybe<Portfolio_BlogPostType>;
  /** A cursor for use in pagination */
  cursor: Scalars['String'];
};

export type Portfolio_BlogPostType = Portfolio_Node & {
  slug: Scalars['String'];
  ...
  id: Scalars['ID'];
  image?: Maybe<Portfolio_ImageType>;
  category?: Maybe<Scalars['String']>;
};
...
export type Portfolio_ImageType = {
  title: Scalars['String'];
  url?: Maybe<Scalars['String']>;
};

export type Portfolio = {
  user?: Maybe<Portfolio_UserType>;
  blogPosts?: Maybe<Portfolio_BlogPostConnection>;
  blogPostBySlug?: Maybe<Portfolio_BlogPostType>;
};
...
export type PortfolioBlogPostsArgs = {
  category?: Maybe<Scalars['String']>;
...
export type PortfolioBlogPostBySlugArgs = {
  slug: Scalars['String'];
};
...
export type SitePageContextFilterInput = {
  ...
  first?: Maybe<IntQueryOperatorInput>;
  ...
  previousPath?: Maybe<StringQueryOperatorInput>;
  nextPath?: Maybe<StringQueryOperatorInput>;
};
...
export type SitePageFieldsEnum =
  ...
  | 'context___hasPreviousPage'
  | 'context___title'
  | 'context___categories'
  | 'context___slug'
  | 'context___previousPath'
  | 'context___nextPath'
  | 'pluginCreator___id'
...
export type SeoQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title' | 'description' | 'url' | 'image'>> }> };

export type GetProfileQueryVariables = Exact<{ [key: string]: never; }>;


export type GetProfileQuery = { portfolio: { user?: Maybe<(
      Pick<Portfolio_UserType, 'username' | 'email'>
      & { profiles: Array<Pick<Portfolio_ProfileType, 'nickname' | 'summary' | 'introduction' | 'locale'>> }
    )> } };
...
export type GetBlogPostsQuery = { portfolio: { blogPosts?: Maybe<{ edges: Array<Maybe<{ node?: Maybe<(
          Pick<Portfolio_BlogPostType, 'slug' | 'title' | 'introduction' | 'publishedAt' | 'category'>
          & { image?: Maybe<Pick<Portfolio_ImageType, 'url' | 'title'>> }
        )> }>> }> } };
...
export type GetBlogPostBySlugQuery = { portfolio: { blogPostBySlug?: Maybe<(
      Pick<Portfolio_BlogPostType, 'slug' | 'category' | 'title' | 'introduction' | 'markdown' | 'publishedAt' | 'updatedAt'>
      & { image?: Maybe<Pick<Portfolio_ImageType, 'url' | 'title'>> }
    )> } };
